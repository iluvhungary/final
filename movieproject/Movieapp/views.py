...
def top_imdb_rated_movies(request):
    top_movies = Movie.objects.order_by('-imdb_rating')[:10]  # Assuming 'imdb_rating' is a field in your Movie model
    return render(request, 'top_imdb_rated_movies.html', {'top_movies': top_movies})
